...
//    }
	...
	public Map<String, Object> deleteCommonCodeGroup(Map<String, Object> map) {
		...
		try {
			int existCnt = commonCodeMapper.isExistCommonCodeGroupChild(map);
			if (existCnt == 0) {
	...
	public List<Map<String, Object>> getCommonCode(Map<String, Object> map) {
		return commonCodeMapper.getCommonCode(map);
	}


	public Map<String, Object> insertCommonCode(Map<String, Object> map) {
		Map<String, Object> message = new HashMap<>();
		...
		try {
			int duplicateCnt = commonCodeMapper.isDuplicateCommonCode(map);
			if (duplicateCnt == 0) {
				int resultCnt = commonCodeMapper.insertCommonCode(map);
				if (resultCnt > 0) {
					result = "등록 되었습니다.";
					resultCode = "1";
				} else {
	...
	public Map<String, Object> deleteCommonCode(Map<String, Object> map) {
		Map<String, Object> message = new HashMap<>();
		...
		try {
			int resultCnt = commonCodeMapper.deleteCommonCode(map);
			if (resultCnt > 0) {
				result = "삭제 되었습니다.";
				resultCode = "1";
			}
	...
	public Map<String, Object> updateCommonCode(Map<String, Object> map) {
		Map<String, Object> message = new HashMap<>();
		...
		try {
			int resultCnt = commonCodeMapper.updateCommonCode(map);
			if (resultCnt > 0) {
				result = "수정 되었습니다.";
				resultCode = "1";
			}
