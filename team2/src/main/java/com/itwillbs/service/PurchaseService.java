...
public class PurchaseService {
	...
	public int insertDetail(Map<String, Object> data) {
		int count =  purchaseMapper.insertDetail(data);
        
        return count;
	}

	public int updateDetail(Map<String, Object> data) {
		 int count = purchaseMapper.updateDetail(data);
