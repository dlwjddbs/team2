...
public class MenuController {
	...
	@PostMapping("/system/getPageHeader")
	@ResponseBody
	public Map<String, Object> getPageHeader(@RequestBody Map<String, Object> map) {
		Map<String, Object> result = menuService.getPageHeader(map);
